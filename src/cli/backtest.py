...
@click.option("--capital", "-c", default=10000.0, show_default=True, help="Capital initial en USDT.")
@click.pass_context
def run(ctx, strategy, from_date, to_date, output, capital):
    ...
    if m.risk_percent_min is not None and m.risk_percent_max is not None:
